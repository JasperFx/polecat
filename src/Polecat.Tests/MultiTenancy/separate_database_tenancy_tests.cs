...
public class separate_database_tenancy_tests : IAsyncLifetime
{
    ...
    private static readonly string MasterConnectionString =
        "Server=localhost,11433;Database=master;User Id=sa;Password=P@55w0rd;TrustServerCertificate=true";

    private static string TenantConnectionString(string dbName) =>
        $"Server=localhost,11433;Database={dbName};User Id=sa;Password=P@55w0rd;TrustServerCertificate=true";
